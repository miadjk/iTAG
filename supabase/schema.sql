...
create table if not exists public.properties (
  ...
  classification text not null check (classification in ('low_value', 'high_value', 'semi_expendable', 'consumable')),
  type text not null default '',
  code text not null default '',
  received_from_name text not null default '',
  received_from_position text not null default '',
...
begin
  ...
  select s.school_id, s.current_quantity, s.minimum_stock_level
    into v_school, v_prev, v_min
